...
def find_ball(opencv_image, debug=False):
    ...
    ball_keypoints = cv2.HoughCircles(opencv_image, cv2.HOUGH_GRADIENT, 1.3, 7, param1=70, param2=20)
    ...
    for keypoint in ball_keypoints:
        ...
        ## INTENSITY CHECK ##
        INTENSITY_THRESHOLD = 50 # @TODO Could be too strict if ball gets reflected with light.
